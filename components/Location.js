function Location() {
    return (
        <div>
            <div>
                <p className="font-1 mb-1 scale-up">Lokasi Acara</p>
                <iframe
                    title="location"
            ...
            <p className="slide-down">Jl. Otto Iskandardinata, Karanganyar, Kec. Subang, Kabupaten Subang, Jawa Barat 41215</p>
            <div className="mt-2 scale-up">
                <a className="center action-button" href="https://maps.app.goo.gl/Rb9hH9uaaTzxmfQn7" target="_blank" role="button" rel="noreferrer"> Buka di Google Maps</a>
            </div>
        </div>
    )
}
